...
const ProjectCard = ({ name, description, tools }: { name: string, description: string, tools: string[] }) => {
    return (
        <div className='rounded-2xl bg-[#161616] border-gunmetalGray border shadow-lg p-6 flex flex-col justify-between gap-4 transition-transform duration-300 hover:-translate-y-2 sm:w-[100%] lg:w-full will-change-transform'>
