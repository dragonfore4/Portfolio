...
{/* <div className="bg-black flex flex-col lg:flex-row min-h-screen w-full gap-20 px-4 md:px-20 relative pt-20"> */ }
import React from "react";
import { FaHtml5, FaCss3Alt, FaJs, FaReact, FaJava, FaDocker, FaAws } from "react-icons/fa";
import { FaGolang } from "react-icons/fa6";
import { RiNextjsFill, RiSupabaseFill } from "react-icons/ri";
import { SiTypescript, SiSvelte, SiTailwindcss, SiExpress, SiMysql, SiMongodb, SiSpringboot, SiJenkins, SiTerraform, SiGithubactions, SiArgo, SiKubernetes } from "react-icons/si";
import { DiOpenshift } from "react-icons/di";

import { DiGit } from "react-icons/di"; // Ensure you have 'react-icons/di' available
...
const skills = [
  ...
  // Backend / Languages
  { name: "Java", icon: <FaJava className="text-red-500" /> },
  { name: "Spring Boot", icon: <SiSpringboot className="text-[#6DBF4A] " /> },
  { name: "Express.js", icon: <SiExpress className="text-white bg-gray-700 p-1 rounded-md" /> },
  { name: "Golang", icon: <FaGolang className="text-blue-300" /> },
  ...
  { name: "Jenkins", icon: <SiJenkins className="text-gray-700 bg-orange-400 p-1 rounded-md" /> },
  { name: "Docker", icon: <FaDocker className="text-blue-600" /> },
  ...
  { name: "Terraform", icon: <SiTerraform className="text-purple-700" /> },
  { name: "Argo CD", icon: <SiArgo className="text-orange-500" /> },
  { name: "AWS Cloud", icon: <FaAws className="text-yellow-600" /> },
];
